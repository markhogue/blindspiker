...
* sv_u = uncertainty in the spike value (optional, not currently used, as spike values are assumed to be at low uncertainty compared to laboratory results)
* sv_k = coverage factor for the spike value uncertainty (optional)
...
* k = coverage factor for the laboratory's uncertainty of the result
